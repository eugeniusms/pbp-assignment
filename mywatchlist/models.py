...
class MyWatchList(models.Model):
    ...
    release_date = models.DateTimeField(default=datetime.now, blank=True) # https://stackoverflow.com/questions/2771676/django-datetime-issues-default-datetime-now
